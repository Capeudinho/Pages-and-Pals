...
public class BookshelfController {
	...
	@PostMapping("create")
	public ResponseEntity<?> create(@RequestBody Bookshelf bookshelf, @RequestHeader("email") String email,
	...
	@PatchMapping("update")
	public ResponseEntity<?> update(@RequestBody Bookshelf bookshelf, @RequestHeader("email") String email,
			@RequestHeader("password") String password) throws Exception {
		ResponseEntity<Object> responseEntity;
		try {
	...
	public ResponseEntity<?> addBookApiIdById(@PathVariable long id, @RequestBody String json,
	...
	public ResponseEntity<?> removeBookApiIdById(@PathVariable long id, @RequestBody String json,
			@RequestHeader("email") String email, @RequestHeader("password") String password) throws Exception {
		ResponseEntity<Object> responseEntity;
		try {
			Gson gson = new Gson();
	...
	public ResponseEntity<?> bookshelfFindOwnById(@PathVariable long id, @RequestHeader("email") String email,
			@RequestHeader("password") String password) throws Exception {
		ResponseEntity<Object> responseEntity;
		try {
	...
	public ResponseEntity<?> bookshelfFindOwnByOwnerIdPaginate(@PathVariable long ownerId,
			@RequestParam(defaultValue = "0") int offset, @RequestParam(defaultValue = "1") int limit,
			@RequestHeader("email") String email, @RequestHeader("password") String password) throws Exception {
		ResponseEntity<Object> responseEntity;
		try {
			List<Map<String, Object>> bookshelfCards = facade.bookshelfFindOwnByOwnerIdPaginate(ownerId, offset, limit,
					email, password);
	...
	public ResponseEntity<?> bookshelfFindByOwnerIdPaginate(@PathVariable long ownerId,
			@RequestParam(defaultValue = "0") int offset, @RequestParam(defaultValue = "1") int limit)
			throws Exception {
		ResponseEntity<Object> responseEntity;
		try {
	...
	public ResponseEntity<?> findOwnBooksByIdPaginate(@PathVariable long id,
			@RequestParam(defaultValue = "0") int offset, @RequestParam(defaultValue = "1") int limit,
			@RequestHeader("email") String email, @RequestHeader("password") String password) throws Exception {
		ResponseEntity<Object> responseEntity;
		try {
			List<Map<String, Object>> books = facade.bookshelfFindOwnBooksByIdPaginate(id, offset, limit, email,
					password);
	...
	public ResponseEntity<?> findBooksByIdPaginate(@PathVariable long id, @RequestParam(defaultValue = "0") int offset,
			@RequestParam(defaultValue = "1") int limit) throws Exception {
		ResponseEntity<Object> responseEntity;
		try {
	...
	public ResponseEntity<?> bookshelfFindOwnSelectByOwnerId(@PathVariable long ownerId, @PathVariable String apiId,
			@RequestHeader("email") String email, @RequestHeader("password") String password) throws Exception {
		ResponseEntity<Object> responseEntity;
		try {
			List<Map<String, Object>> bookshelfSelects = facade.bookshelfFindOwnSelectByOwnerId(ownerId, apiId, email,
					password);
	...
	public ResponseEntity<?> bookshelfFindSelectByOwnerId(@PathVariable long ownerId, @PathVariable String apiId)
			throws Exception {
		ResponseEntity<Object> responseEntity;
		try {
