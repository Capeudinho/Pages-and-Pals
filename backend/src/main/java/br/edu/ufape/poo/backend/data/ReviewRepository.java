...
public interface ReviewRepository extends JpaRepository<Review, Long>{
	...
	public List<Review> findByBookApiIdAndPrivacyOrOwnerIdOrderByCreationDateDesc(@Param("bookApiId") String bookApiId, @Param("ownerId") long ownerId, @Param("privacy") boolean privacy, Pageable pageable);
